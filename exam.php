...
$query = "SELECT * FROM tb_department ORDER BY dep_name asc" or die("Error:" . mysqli_error());
...
<form action="department_adddb.php" method="post" class="form-horizontal">
  ...
  <select name="test" class="form-control" required>
    ...
    <option value="<?php echo $results["dep_name"];?>">
      <?php echo $results["dep_name"]; ?>
      </option>
    <?php } ?>
  </select>
</div>
